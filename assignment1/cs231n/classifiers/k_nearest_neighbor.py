...
class KNearestNeighbor(object):
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #closest_y = self.y_train[min_dist_idx]
      sort_idx = np.argsort(dists[i,:])
      closest_y = list(self.y_train[sort_idx[range(k)]])
      #########################################################################
      # TODO:                                                                 #
      ...
      # label.                                                                #
      #########################################################################
      common_set = set([x for x in closest_y if closest_y.count(x) > 1])
      if common_set:
        y_pred[i] = min(common_set)
      else:
